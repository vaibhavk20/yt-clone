...
const random = async (req, res, next) => {
  try {
    // sample help to get the random video each time
...
const sub = async (req, res, next) => {
  try {
    ...
    //   flat is help to give proper structure and sort give recent one
...
const search = async (req, res, next) => {
  ...
  try {
    //regex is help to find in between word in title it is provided by mongodb
    // options is help to case sensitive
